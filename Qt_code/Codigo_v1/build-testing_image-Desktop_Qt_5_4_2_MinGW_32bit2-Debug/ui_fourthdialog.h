...
public:
    ...
    void setupUi(QDialog *fourthDialog)
    {
        ...
        pushButton->setGeometry(QRect(160, 250, 51, 41));
        ...
        pushButton_5->setGeometry(QRect(490, 380, 75, 23));
        ...
        pushButton_2->setGeometry(QRect(160, 300, 51, 41));
