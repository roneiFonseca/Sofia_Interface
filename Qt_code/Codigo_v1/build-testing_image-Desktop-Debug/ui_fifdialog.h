...
public:
    ...
    void setupUi(QDialog *fifDialog)
    {
        ...
        pushButton->setGeometry(QRect(430, 360, 75, 23));
        radioButton = new QRadioButton(fifDialog);
        radioButton->setObjectName(QStringLiteral("radioButton"));
        radioButton->setGeometry(QRect(40, 200, 351, 51));
        radioButton_2 = new QRadioButton(fifDialog);
        radioButton_2->setObjectName(QStringLiteral("radioButton_2"));
        radioButton_2->setGeometry(QRect(40, 250, 291, 41));
        radioButton_3 = new QRadioButton(fifDialog);
        radioButton_3->setObjectName(QStringLiteral("radioButton_3"));
        radioButton_3->setGeometry(QRect(40, 310, 291, 31));
